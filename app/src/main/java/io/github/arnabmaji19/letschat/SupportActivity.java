...
public class SupportActivity extends AppCompatActivity {
    ...
    private final static String SUPPORT_SUBJECT = "LetsChat Support";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView[] socialMediaIcons = {findViewById(R.id.facebook),
                findViewById(R.id.instagram),
        ...
        findViewById(R.id.whatsapp).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) { //On WhatsApp Click, directs User to Support Number
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(SupportActivity.this,"Whatsapp not installed!",Toast.LENGTH_LONG).show();
                }
            }
        });
